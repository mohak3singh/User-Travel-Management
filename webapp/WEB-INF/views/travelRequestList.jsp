...
<body ng-app="app">
	...
	<div align="center" style="width: 80%; margin: 0 auto"
		ng-controller="travelRequestController">
		...
		<input type="hidden" value="${travellerId}" id="travellerId" />
		<input type="hidden" value="${travelId}" id="travelId" />
		<input type="hidden" value="${unitId}" id="unitId" />
		<input type="hidden" value="${action}" id="action" />
		
		<h1 id="allHeadingCss">Travel Request List</h1>
		<div style="clear: both; margin: 2px 0; color: red;" id="div_list_msg">${msg}</div>
		<div style="float: left; width: 60%; text-align: right;"></div>
		<div style="float: right; font-size: 14px;"></div>

		<table id="travelRequestTable" class="table table-striped table-bordered">
			<thead>
				<tr>
					<th>Sr. No.</th>
					<th>Unit</th>
